...
- Name: about.spec.ts >> About page >> 4 values visible
- Location: tests\about.spec.ts:35:7
...
Locator: getByText('Real Mentors')
Expected: visible
Error: strict mode violation: getByText('Real Mentors') resolved to 3 elements:
    1) <p class="text-gray-400 leading-relaxed">The answer wasn't talent — it was the gap between…</p> aka getByText('The answer wasn\'t talent — it')
    2) <div class="font-semibold text-navy mb-1">Real Mentors</div> aka getByText('Real Mentors', { exact: true })
    3) <p class="text-sm text-gray-400 leading-relaxed mb-5">…</p> aka getByText('Learn Today. Place Tomorrow.')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Real Mentors')
