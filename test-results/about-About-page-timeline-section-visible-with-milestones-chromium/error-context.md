...
- Name: about.spec.ts >> About page >> timeline section visible with milestones
- Location: tests\about.spec.ts:48:7

# Error details

```
Error: locator.scrollIntoViewIfNeeded: Error: strict mode violation: getByText('Our Journey') resolved to 2 elements:
    1) <h2 class="section-title text-center mb-12">Our Journey</h2> aka getByRole('heading', { name: 'Our Journey' })
    2) <a href="/contact" class="btn-primary text-base px-8 py-3.5">Start Your Journey →</a> aka getByRole('link', { name: 'Start Your Journey →' })

Call log:
  - waiting for getByText('Our Journey')
