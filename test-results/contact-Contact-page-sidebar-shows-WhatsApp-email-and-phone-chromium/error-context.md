...
- Name: contact.spec.ts >> Contact page >> sidebar shows WhatsApp, email and phone
- Location: tests\contact.spec.ts:73:7
...
Locator: getByText('techrisewithai@gmail.com')
Expected: visible
Error: strict mode violation: getByText('techrisewithai@gmail.com') resolved to 2 elements:
    1) <div class="font-semibold text-navy text-sm group-hover:text-saffron transition-colors">techrisewithai@gmail.com</div> aka getByRole('link', { name: '✉️ Email techrisewithai@gmail' })
    2) <a href="mailto:techrisewithai@gmail.com" class="flex items-center gap-2 text-gray-400 hover:text-white transition-colors">…</a> aka getByRole('link', { name: '✉️ techrisewithai@gmail.com' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('techrisewithai@gmail.com')
