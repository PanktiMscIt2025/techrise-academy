...
- Name: about.spec.ts >> About page >> founder section shows Pankti Patel
- Location: tests\about.spec.ts:20:7
...
Locator: getByText('Pankti Patel')
Expected: visible
Error: strict mode violation: getByText('Pankti Patel') resolved to 3 elements:
    1) <h2 class="font-heading font-bold text-navy text-3xl mb-2">Pankti Patel</h2> aka getByRole('heading', { name: 'Pankti Patel' })
    2) <div class="font-heading font-bold text-navy">Pankti Patel</div> aka locator('div').filter({ hasText: /^Pankti Patel$/ })
    3) <div class="text-sm text-gray-600">TechRise Academy founded by Pankti Patel with fir…</div> aka getByText('TechRise Academy founded by')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Pankti Patel')
