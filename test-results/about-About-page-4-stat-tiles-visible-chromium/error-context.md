...
- Name: about.spec.ts >> About page >> 4 stat tiles visible
- Location: tests\about.spec.ts:13:7
...
Locator: getByText('Students Trained')
Expected: visible
Error: strict mode violation: getByText('Students Trained') resolved to 2 elements:
    1) <div class="text-sm text-gray-300">Students Trained</div> aka getByText('Students Trained', { exact: true })
    2) <div class="text-sm text-gray-600">500+ students trained. 95% placement rate. YouTub…</div> aka getByText('500+ students trained. 95%')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Students Trained')
