...
- Name: homepage.spec.ts >> Homepage >> hero tagline visible
...
Locator: getByText('Learn Today.')
Expected: visible
Error: strict mode violation: getByText('Learn Today.') resolved to 2 elements:
    1) <h1 class="font-heading font-extrabold text-4xl sm:text-5xl lg:text-6xl text-white mb-6">…</h1> aka getByRole('heading', { name: 'Learn Today. Place Tomorrow.' })
    2) <p class="text-sm text-gray-400 leading-relaxed mb-5">…</p> aka getByText('Learn Today. Place Tomorrow.Industry-ready tech education with real mentors and')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Learn Today.')
